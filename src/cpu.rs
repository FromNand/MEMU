...
lazy_static! {
    static ref INST_LIST: Vec<Instruction> = vec![
        ...
        Instruction::new(0x1e, "ASL", AddrMode::ABX, CPU::asl, 3, 6, CycleMode::Page),
        ...
        Instruction::new(0xde, "DEC", AddrMode::ABX, CPU::dec, 3, 6, CycleMode::Page),
        ...
        Instruction::new(0x5d, "EOR", AddrMode::ABX, CPU::eor, 3, 4, CycleMode::Page),
        Instruction::new(0x59, "EOR", AddrMode::ABY, CPU::eor, 3, 4, CycleMode::Page),
        Instruction::new(0x41, "EOR", AddrMode::INX, CPU::eor, 2, 6, CycleMode::None),
        Instruction::new(0x51, "EOR", AddrMode::INY, CPU::eor, 2, 5, CycleMode::Page),
        ...
        Instruction::new(0xfe, "INC", AddrMode::ABX, CPU::inc, 3, 6, CycleMode::Page),
        ...
        Instruction::new(0x5e, "LSR", AddrMode::ABX, CPU::lsr, 3, 6, CycleMode::Page),
        ...
        Instruction::new(0x3e, "ROL", AddrMode::ABX, CPU::rol, 3, 6, CycleMode::Page),
        ...
        Instruction::new(0x7e, "ROR", AddrMode::ABX, CPU::ror, 3, 6, CycleMode::Page),
        ...
        Instruction::new(0x9d, "STA", AddrMode::ABX, CPU::sta, 3, 4, CycleMode::Page),
        Instruction::new(0x99, "STA", AddrMode::ABY, CPU::sta, 3, 4, CycleMode::Page),
        Instruction::new(0x81, "STA", AddrMode::INX, CPU::sta, 2, 6, CycleMode::None),
        Instruction::new(0x91, "STA", AddrMode::INY, CPU::sta, 2, 5, CycleMode::Page),
        ...
        Instruction::new(0xdf, "*DCP", AddrMode::ABX, CPU::dcp, 3, 6, CycleMode::Page),
        Instruction::new(0xdb, "*DCP", AddrMode::ABY, CPU::dcp, 3, 6, CycleMode::Page),
        Instruction::new(0xc3, "*DCP", AddrMode::INX, CPU::dcp, 2, 8, CycleMode::None),
        Instruction::new(0xd3, "*DCP", AddrMode::INY, CPU::dcp, 2, 7, CycleMode::Page),
        ...
        Instruction::new(0xff, "*ISB", AddrMode::ABX, CPU::isb, 3, 6, CycleMode::Page),
        Instruction::new(0xfb, "*ISB", AddrMode::ABY, CPU::isb, 3, 6, CycleMode::Page),
        Instruction::new(0xe3, "*ISB", AddrMode::INX, CPU::isb, 2, 8, CycleMode::None),
        Instruction::new(0xf3, "*ISB", AddrMode::INY, CPU::isb, 2, 7, CycleMode::Page),
        ...
        Instruction::new(0x3f, "*RLA", AddrMode::ABX, CPU::rla, 3, 6, CycleMode::Page),
        Instruction::new(0x3b, "*RLA", AddrMode::ABY, CPU::rla, 3, 6, CycleMode::Page),
        Instruction::new(0x23, "*RLA", AddrMode::INX, CPU::rla, 2, 8, CycleMode::None),
        Instruction::new(0x33, "*RLA", AddrMode::INY, CPU::rla, 2, 7, CycleMode::Page),
        ...
        Instruction::new(0x7f, "*RRA", AddrMode::ABX, CPU::rra, 3, 6, CycleMode::Page),
        Instruction::new(0x7b, "*RRA", AddrMode::ABY, CPU::rra, 3, 6, CycleMode::Page),
        Instruction::new(0x63, "*RRA", AddrMode::INX, CPU::rra, 2, 8, CycleMode::None),
        Instruction::new(0x73, "*RRA", AddrMode::INY, CPU::rra, 2, 7, CycleMode::Page),
        ...
        Instruction::new(0x1f, "*SLO", AddrMode::ABX, CPU::slo, 3, 6, CycleMode::Page),
        Instruction::new(0x1b, "*SLO", AddrMode::ABY, CPU::slo, 3, 6, CycleMode::Page),
        Instruction::new(0x03, "*SLO", AddrMode::INX, CPU::slo, 2, 8, CycleMode::None),
        Instruction::new(0x13, "*SLO", AddrMode::INY, CPU::slo, 2, 7, CycleMode::Page),
        ...
        Instruction::new(0x5f, "*SRE", AddrMode::ABX, CPU::sre, 3, 6, CycleMode::Page),
        Instruction::new(0x5b, "*SRE", AddrMode::ABY, CPU::sre, 3, 6, CycleMode::Page),
        Instruction::new(0x43, "*SRE", AddrMode::INX, CPU::sre, 2, 8, CycleMode::None),
        Instruction::new(0x53, "*SRE", AddrMode::INY, CPU::sre, 2, 7, CycleMode::Page),
    ];
...
impl CPU {
    ...
    fn sbc(&mut self) {
        let a = self.a as u16;
        let b = self.read8(self.addr) as u16;
        let r = a.wrapping_sub(b).wrapping_sub(!self.p.c as u16);
        self.a = r as u8;
        self.p.c = r <= 0xff;
